...
var HTable = (function () {
    function HTable(up, down, symbol, weight) {
...
var Huffman = (function () {
    ...
    //  of nodes to be used
    function Huffman(size, root, bitstream, max_weight) {
        var i;
    ...
    Huffman.compressFile = function (data, size) {
    ...
    Huffman.decompressFile = function (data, size) {
        var alphabetSize = 256;
        if (size < 0) {
            alphabetSize++;
        }
...
//# sourceMappingURL=huffman2.js.map