 ...
 */
compressJS.Lzp3 = (function (module) {
	var Context1Model = module.Context1Model,
		FenwickModel = module.FenwickModel,
		LogDistanceModel = module.LogDistanceModel,
		NoModel = module.NoModel,
		RangeCoder = module.RangeCoder,
	...
	Lzp3.compressFile = Util.compressFileHelper(Lzp3.MAGIC, function (inStream, outStream, fileSize, props) {
		...
		range.encodeStart(FORMAT_VERSION, 0); // 0x00 == range encoded
	...
	Lzp3.decompressFile = Util.decompressFileHelper(Lzp3.MAGIC, function (inStream, outStream, fileSize) {
		...
		if (version !== FORMAT_VERSION) {
			throw new Error("format version " + version + " incorrect. Should be " + FORMAT_VERSION);
		}
